...
restup-cli/1.0.3 win32-x64 node-v14.4.0
$ restup --help [COMMAND]
USAGE
  $ restup COMMAND
...
...
_See code: [src\commands\controller.ts](https://github.com/codenitiva/restup-cli/blob/v1.0.3/src\commands\controller.ts)_
...
_See code: [src\commands\middleware.ts](https://github.com/codenitiva/restup-cli/blob/v1.0.3/src\commands\middleware.ts)_
...
_See code: [src\commands\router.ts](https://github.com/codenitiva/restup-cli/blob/v1.0.3/src\commands\router.ts)_
